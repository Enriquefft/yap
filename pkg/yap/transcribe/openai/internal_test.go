...
// zero the constructor substitutes DefaultTimeout instead of
// building &http.Client{Timeout: 0}, which would disable the
// timeout entirely.
...
// timeout is treated as "use the default" rather than passed
// through to http.Client (which would be indistinguishable from
// zero).
