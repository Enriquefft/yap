...
// TestNoPackageLevelMutableState enforces that the passthrough package
// never introduces any package-level var — it is the degenerate
// identity transformer and has nothing to store.
